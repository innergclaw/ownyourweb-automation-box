const FIELD_DEFINITIONS = {
  ...
  scaleScore: ["scale score", "scaled score", "pssa scale score"],
  performanceCode: ["perf code", "performance code", "proficiency code"],
  performance: ["performance", "performance level", "proficiency level"],
