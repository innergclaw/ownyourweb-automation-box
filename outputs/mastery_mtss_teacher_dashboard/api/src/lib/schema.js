const FIELD_DEFINITIONS = {
  ...
  firstName: ["first name", "first_name", "firstname", "student first name", "given name"],
  lastName: ["last name", "last_name", "lastname", "student last name", "surname", "family name"],
  grade: ["grade", "grade level", "grade_level", "current grade"],
  campus: ["campus", "school", "school name", "school campus"],
  ...
  attendance: ["attendance", "attendance percent", "attendance rate", "attendance_pct", "pct attendance"],
  enrolledDays: ["enrolled days", "days enrolled"],
  participation: ["participation", "participation percent", "participation rate"],
