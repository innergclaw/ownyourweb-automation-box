const FIELD_DEFINITIONS = {
  studentId: ["student id", "student_id", "studentid", "id number", "student number", "local id", "sis id"],
  ...
  assessment: ["assessment", "assessment name", "test", "test name", "measure"],
  score: ["score", "raw score", "raw_score", "points earned", "result"],
  ...
  testDate: ["test date", "assessment date", "date", "test_date"],
  reportingPeriod: ["reporting period", "term", "quarter", "marking period", "period"],
